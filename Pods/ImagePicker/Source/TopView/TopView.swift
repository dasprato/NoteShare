...
open class TopView: UIView {
  ...
  @objc var currentFlashIndex = 0
  @objc let flashButtonTitles = ["AUTO", "ON", "OFF"]

  @objc open lazy var flashButton: UIButton = { [unowned self] in
    let button = UIButton()
  ...
  @objc open lazy var rotateCamera: UIButton = { [unowned self] in
    let button = UIButton()
