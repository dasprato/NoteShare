...
open class ImageGalleryView: UIView {
  ...
  @objc lazy open var collectionView: UICollectionView = { [unowned self] in
  ...
  @objc lazy var collectionViewLayout: UICollectionViewLayout = { [unowned self] in
  ...
  @objc lazy var topSeparator: UIView = { [unowned self] in
    let view = UIView()
  ...
  @objc open lazy var noImagesLabel: UILabel = { [unowned self] in
    let label = UILabel()
  ...
  @objc lazy var assets = [PHAsset]()

  weak var delegate: ImageGalleryPanGestureDelegate?
  var collectionSize: CGSize?
  @objc var shouldTransform = false
  @objc var imagesBeforeLoading = 0
  @objc var fetchResult: PHFetchResult<AnyObject>?
  ...
  @objc func fetchPhotos(_ completion: (() -> Void)? = nil) {
  ...
  @objc func displayNoImagesMessage(_ hideCollectionView: Bool) {
