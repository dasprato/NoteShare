...
open class BottomContainerView: UIView {
  ...
  @objc lazy var pickerButton: ButtonPicker = { [unowned self] in
  ...
  @objc lazy var borderPickerButton: UIView = {
    let view = UIView()
  ...
  @objc open lazy var doneButton: UIButton = { [unowned self] in
    let button = UIButton()
  ...
  @objc lazy var stackView = ImageStackView(frame: CGRect(x: 0, y: 0, width: 80, height: 80))
  ...
  @objc lazy var tapGestureRecognizer: UITapGestureRecognizer = { [unowned self] in
