...
open class ImagePickerController: UIViewController {
  ...
  @objc open lazy var galleryView: ImageGalleryView = { [unowned self] in
  ...
  @objc open lazy var bottomContainer: BottomContainerView = { [unowned self] in
  ...
  @objc open lazy var topView: TopView = { [unowned self] in
  ...
  @objc lazy var cameraController: CameraView = { [unowned self] in
  ...
  @objc lazy var panGestureRecognizer: UIPanGestureRecognizer = { [unowned self] in
  ...
  @objc lazy var volumeView: MPVolumeView = { [unowned self] in
  ...
  @objc var volume = AVAudioSession.sharedInstance().outputVolume
  ...
  @objc var totalSize: CGSize { return UIScreen.main.bounds.size }
  var initialFrame: CGRect?
  var initialContentOffset: CGPoint?
  var numberOfCells: Int?
  @objc var statusBarHidden = true

  fileprivate var isTakingPicture = false
  @objc open var doneButtonTitle: String? {
    didSet {
  ...
  @objc func presentAskPermissionAlert() {
  ...
  @objc open func collapseGalleryView(_ completion: (() -> Void)?) {
  ...
  @objc open func showGalleryView() {
    galleryView.collectionViewLayout.invalidateLayout()
    UIView.animate(withDuration: 0.3, animations: {
  ...
  @objc open func expandGalleryView() {
    galleryView.collectionViewLayout.invalidateLayout()
...
extension ImagePickerController: BottomContainerViewDelegate {
  ...
  @objc func pickerButtonDidPress() {
    takePicture()
  }
  ...
  @objc func imageStackViewDidPress() {
    var images: [UIImage]
    if let preferredImageSize = preferredImageSize {
        images = AssetManager.resolveAssets(stack.assets, size: preferredImageSize)
    } else {
...
extension ImagePickerController: CameraViewDelegate {
  ...
  @objc func applyOrientationTransforms() {
...
extension ImagePickerController: TopViewDelegate {
  ...
  @objc func flashButtonDidPress(_ title: String) {
    cameraController.flashCamera(title)
  }

  @objc func rotateDeviceDidPress() {
...
extension ImagePickerController: ImageGalleryPanGestureDelegate {
  ...
  @objc func panGestureDidChange(_ translation: CGPoint) {
  ...
  @objc func panGestureDidEnd(_ translation: CGPoint, velocity: CGPoint) {
    guard let initialFrame = initialFrame else { return }
    let galleryHeight = initialFrame.height - translation.y
